...
if __name__ == "__main__":
    ...
    if first_arg == 'work':
        ...
        # print('Checking if it exists, list below')
        # print(dock_app_list)
        ...
        try:
            ...
            print("Please restart your terminal or do 'source ~/.bash_profile' for changes to take effect.")
        except IOError:
        ...
        print("Usage: 'python dock.py <command>', or '{} <command> if alias is set.".format(alias_name))
